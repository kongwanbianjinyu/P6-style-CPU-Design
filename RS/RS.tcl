...
read_file -f ddc [list "num_ones/num_ones.ddc"]
set_dont_touch num_ones
...
#read_file -f ddc [list "wand_sel_WIDTH64.ddc"]
#set_dont_touch wand_sel_WIDTH64

read_file -f sverilog [list "ISA.svh" "sys_defs.svh" "RS.sv"]
set design_name RS
set clock_name clk
